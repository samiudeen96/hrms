...
const SideBar = () => {
    ...
    return (
        <div className="w-60 h-screen border-r border-gray-200/50 sticky top-0 z-20 overflow-y-scroll flex justify-center p-5">
            <div className="w-full">
                ...
                {adminMenu.map((item, index) => (
                    <div key={`menu-${index}`} className="my-3">
                        {item.menu ? (
                                ...
                                return (
                                    <div key={`child-${key}`} className="mb-2">
                                        ...
                                        <div
                                            ...
                                            className={`flex items-center justify-between p-2 cursor-pointer border-l-2 hover:border-primary hover:text-primary
                                                    ...
                                                    return (
                                                        <div
                                                            ...
                                                            className={`line py-2 ps-3.5 text-xs cursor-pointer flex items-center group 
                                                                ${isSubActive ? "text-primary font-semibold" : "text-gray-600 hover:text-primary"}`}
                                                        >
                                                            <div
